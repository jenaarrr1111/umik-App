...
class SellerRute extends StatefulWidget {
  const SellerRute({super.key});

  static String routeName = '/seller_rute';

  @override
  State<SellerRute> createState() => _SellerRuteState();
}

class _SellerRuteState extends State<SellerRute> {
  var statusPesanan = StatusPesanan.diproses;
              ...
              children: [
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      setState(() {
                        statusPesanan = StatusPesanan.diantar;
                      });
                    },
                    style: ElevatedButton.styleFrom(
                      backgroundColor: kPrimaryColor,
